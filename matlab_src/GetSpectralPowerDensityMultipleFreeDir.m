...
runname = 'may9'; %mod this line to reflect the set of runs being computed
runs_root_folder = '/Users/rogerfu/Dropbox/ceres_dropbox/ceres_public/';
%runlist_filename file must be in the runs_root_folder
runlist_filename = [runs_root_folder 'may9_runlist']; %mod this line for the runlist .txt file
